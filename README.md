...
Service Catalog recently switched to a new [CRDs](https://kubernetes.io/docs/concepts/extend-kubernetes/api-extension/custom-resources/#custom-resources) based architecture. The old API-server based implementation is available on the [v0.2.0 branch](https://github.com/kubernetes-sigs/service-catalog/tree/v0.2.0). We plan to support this implementation (by providing bug fixes) till July 2020.

We are currently working toward a beta-quality release. See the [milestones list](https://github.com/kubernetes-sigs/service-catalog/milestones?direction=desc&sort=due_date&state=open)
